function main() {
    ...
    var vertices = [
        ...
        //left
        //left-front //red
        4, -4, -0.5, 1, 0, 0, 0, 0, 1, // Index:  175   
        4, -1, -0.5, 1, 0, 0, 0, 0, 1, // Index:  176
        3.5, -1, -0.5, 1, 0, 0, 0, 0, 1, // Index:  177
        3.5, -4, -0.5, 1, 0, 0, 0, 0, 1, // Index:  178
        //left-back     //orange
        4, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  179
        4, -1, -1, 1, 0.5, 0, 0, 0, 1, // Index:  180
        3.5, -1, -1, 1, 0.5, 0, 0, 0, 1, // Index: 181
        3.5, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  182
        //left-left //yellow
        4, -1, -1, 1, 1, 0, 1, 0, 0, // Index: 183
        4, -4, -1, 1, 1, 0, 1, 0, 0, // Index: 184
        4, -4, -0.5, 1, 1, 0, 1, 0, 0, // Index: 185
        4, -1, -0.5, 1, 1, 0, 1, 0, 0, // Index: 186
        //left-right //green
        3.5, -1, -1, 0, 1, 0, 1, 0, 0, // Index: 187
        3.5, -4, -1, 0, 1, 0, 1, 0, 0, // Index: 188
        3.5, -4, -0.5, 0, 1, 0, 1, 0, 0, // Index: 189
        3.5, -1, -0.5, 0, 1, 0, 1, 0, 0, // Index: 190
        //left-bottom      //white
        3.5, -1, -1, 1, 1, 1, 0, -1, 0, // Index: 191
        3.5, -1, -0.5, 1, 1, 1, 0, -1, 0, // Index: 192
        4, -1, -0.5, 1, 1, 1, 0, -1, 0, // Index: 193
        4, -1, -1, 1, 1, 1, 0, -1, 0, // Index: 194
        //left-top      //blue
        3.5, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 195
        3.5, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 196
        4, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 197
        4, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 198

        //right
        //right-front   //red
        2.7, -4, -0.5, 1, 0, 0, 0, 0, 1, // Index:  199    
        2.7, -1, -0.5, 1, 0, 0, 0, 0, 1, // Index:  200
        2.2, -1, -0.5, 1, 0, 0, 0, 0, 1, // Index:  201
        2.2, -4, -0.5, 1, 0, 0, 0, 0, 1, // Index:  202
        //right-back //orange
        2.7, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  203  
        2.7, -1, -1, 01, 0.5, 0, 0, 0, 1, // Index:  204
        2.2, -1, -1, 1, 0.5, 0, 0, 0, 1, // Index:  205
        2.2, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  206
        //right-left //yellow
        2.7, -1, -1, 1, 1, 0, 1, 0, 0, // Index: 207
        2.7, -4, -1, 1, 1, 0, 1, 0, 0, // Index: 208
        2.7, -4, -0.5, 1, 1, 0, 1, 0, 0, // Index: 209
        2.7, -1, -0.5, 1, 1, 0, 1, 0, 0, // Index: 210
        //right-right //green
        2.2, -1, -1, 0, 1, 0, 1, 0, 0, // Index: 211
        2.2, -4, -1, 0, 1, 0, 1, 0, 0, // Index: 212
        2.2, -4, -0.5, 0, 1, 0, 1, 0, 0, // Index: 213
        2.2, -1, -0.5, 0, 1, 0, 1, 0, 0, // Index: 214
        //right-bottom      //white
        2.7, -1, -1, 1, 1, 1, 0, -1, 0, // Index: 215
        2.7, -1, -0.5, 1, 1, 1, 0, -1, 0, // Index: 216
        2.2, -1, -0.5, 1, 1, 1, 0, -1, 0, // Index: 217
        2.2, -1, -1, 1, 1, 1, 0, -1, 0, // Index: 218
        //right-top      //blue
        2.2, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 219
        2.2, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 220
        2.7, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 221
        2.7, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 222

        //top
        //top-front          //red
        4, -4, -0.5, 1, 0, 0, 0, 0, -1, // Index:  223
        4, -3.4, -0.5, 1, 0, 0, 0, 0, -1, //Index:  224
        2.5, -3.4, -0.5, 1, 0, 0, 0, 0, -1, // Index:  225
        2.5, -4, -0.5, 1, 0, 0, 0, 0, -1, // Index:  226
        //top-back           //orange
        4, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  227
        4, -3.4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  228
        2.5, -3.4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  229
        2.5, -4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  230
        //top-top      //blue
        2.5, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 231
        2.5, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 232
        4, -4, -1, 0, 0, 1, 0, -1, 0, // Index: 233
        4, -4, -0.5, 0, 0, 1, 0, -1, 0, // Index: 234
        //top-bottom        //white
        4, -3.4, -0.5, 1, 1, 1, 0, -1, 0, // Index: 235
        4, -3.4, -1, 1, 1, 1, 0, -1, 0, // Index: 236
        2.5, -3.4, -1, 1, 1, 1, 0, -1, 0, // Index: 237
        2.5, -3.4, -0.5, 1, 1, 1, 0, -1, 0, // Index: 238

        //middle
        //middle-front          //red
        4, -3, -0.5, 1, 0, 0, 0, 0, -1, // Index:  239
        4, -2.4, -0.5, 1, 0, 0, 0, 0, -1, //Index:  240
        2.5, -2.4, -0.5, 1, 0, 0, 0, 0, -1, // Index:  241
        2.5, -3, -0.5, 1, 0, 0, 0, 0, -1, // Index:  242
        //middle-back           //orange
        4, -3, -1, 1, 0.5, 0, 0, 0, 1, // Index:  243
        4, -2.4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  244
        2.5, -2.4, -1, 1, 0.5, 0, 0, 0, 1, // Index:  245
        2.5, -3, -1, 1, 0.5, 0, 0, 0, 1, // Index:  246
        //middle-top      //blue
        2.5, -3, -0.5, 0, 0, 1, 0, -1, 0, // Index: 247
        2.5, -3, -1, 0, 0, 1, 0, -1, 0, // Index: 248
        4, -3, -1, 0, 0, 1, 0, -1, 0, // Index: 249
        4, -3, -0.5, 0, 0, 1, 0, -1, 0, // Index: 250
        //middle-bottom        //white
        4, -2.4, -0.5, 1, 1, 1, 0, -1, 0, // Index: 251
        4, -2.4, -1, 1, 1, 1, 0, -1, 0, // Index: 252
        2.5, -2.4, -1, 1, 1, 1, 0, -1, 0, // Index: 253
        2.5, -2.4, -0.5, 1, 1, 1, 0, -1, 0, // Index: 254

        //alphabet K
        //left-front //yellow
        4, 4, -0.5, 1, 1, 0, 0, 0, 1, // Index:  255
        4, 1, -0.5, 1, 1, 0, 0, 0, 1, // Index:  256
        3.5, 1, -0.5, 1, 1, 0, 0, 0, 1, // Index: 257
        3.5, 4, -0.5, 1, 1, 0, 0, 0, 1, // Index:  258
        //left-back //blue
        4, 4, -1, 0, 0, 1, 0, 0, 1, // Index:  259
        4, 1, -1, 0, 0, 1, 0, 0, 1, // Index:  260
        3.5, 1, -1, 0, 0, 1, 0, 0, 1, // Index:  261
        3.5, 4, -1, 0, 0, 1, 0, 0, 1, // Index:  262
        //left-left //red
        4, 1, -1, 1, 0, 0, 1, 0, 0, // Index: 263
        4, 4, -1, 1, 0, 0, 1, 0, 0, // Index: 264
        4, 4, -0.5, 1, 0, 0, 1, 0, 0, // Index: 265
        4, 1, -0.5, 1, 0, 0, 1, 0, 0, // Index: 266
        //left-right 
        3.5, 1, -1, 1, 1, 1, 1, 0, 0, // Index: 267
        3.5, 4, -1, 1, 1, 1, 1, 0, 0, // Index: 268
        3.5, 4, -0.5, 1, 1, 1, 1, 0, 0, // Index: 269
        3.5, 1, -0.5, 1, 1, 1, 1, 0, 0, // Index: 270
        //top-top     //green
        3.5, 1, -1, 1, 0.5, 0, 0, -1, 0, // Index: 271
        3.5, 1, -0.5, 1, 0.5, 0, 0, -1, 0, // Index: 272
        4, 1, -0.5, 1, 0.5, 0, 0, -1, 0, // Index: 273
        4, 1, -1, 1, 0.5, 0, 0, -1, 0, // Index: 274
        //top-bottom      //green
        3.5, 4, -1, 0, 1, 0, 0, -1, 0, // Index: 275
        3.5, 4, -0.5, 0, 1, 0, 0, -1, 0, // Index: 276
        4, 4, -0.5, 0, 1, 0, 0, -1, 0, // Index: 277
        4, 4, -1, 0, 1, 0, 0, -1, 0, // Index: 278

        //k-right
        //middle up
        //up-front          //yellow
        4, 3, -0.5, 1, 1, 0, 0, 0, -1, // Index:  279
        4, 2.4, -0.5, 1, 1, 0, 0, 0, -1, //Index:  280
        2, 1, -0.5, 1, 1, 0, 0, 0, -1, // Index:  281
        2, 1.6, -0.5, 1, 1, 0, 0, 0, -1, // Index:  282
        //up-back           //blue
        4, 3, -1, 0, 0, 1, 0, 0, 1, // Index:  283
        4, 2.4, -1, 0, 0, 1, 0, 0, 1, // Index:  284
        2, 1, -1, 0, 0, 1, 0, 0, 1, // Index:  285
        2, 1.6, -1, 0, 0, 1, 0, 0, 1, // Index:  286
        //up-top      //red
        2, 1, -0.5, 1, 0, 0, 0, -1, 0, // Index: 287
        2, 1, -1, 1, 0, 0, 0, -1, 0, // Index: 288
        4, 2.4, -1, 1, 0, 0, 0, -1, 0, // Index: 289
        4, 2.4, -0.5, 1, 0, 0, 0, -1, 0, // Index: 290
        //up-bottom        //green
        2, 1.6, -0.5, 0, 1, 0, 0, -1, 0, // Index: 291
        2, 1.6, -1, 0, 1, 0, 0, -1, 0, // Index: 292
        4, 3, -1, 0, 1, 0, 0, -1, 0, // Index: 293
        4, 3, -0.5, 0, 1, 0, 0, -1, 0, // Index: 294
        //upright 
        2, 1.6, -1, 1, 1, 1, 1, 0, 0, // Index: 295
        2, 1, -1, 1, 1, 1, 1, 0, 0, // Index: 296
        2, 1, -0.5, 1, 1, 1, 1, 0, 0, // Index: 297
        2, 1.6, -0.5, 1, 1, 1, 1, 0, 0, // Index: 298

        //k-down
        //middle
        //down-front          //yellow
        4, 3, -0.5, 1, 1, 0, 0, 0, -1, // Index:  299
        4, 2.4, -0.5, 1, 1, 0, 0, 0, -1, //Index:  300
        2, 3.4, -0.5, 1, 1, 0, 0, 0, -1, // Index:  301
        2, 4, -0.5, 1, 1, 0, 0, 0, -1, // Index:  302
        //down-back           //blue
        4, 3, -1, 0, 0, 1, 0, 0, 1, // Index:  303
        4, 2.4, -1, 0, 0, 1, 0, 0, 1, // Index:  304
        2, 3.4, -1, 0, 0, 1, 0, 0, 1, // Index:  305
        2, 4, -1, 0, 0, 1, 0, 0, 1, // Index:  306
        //down-top      //red
        2, 3.4, -0.5, 1, 0, 0, 0, -1, 0, // Index: 307
        2, 3.4, -1, 1, 0, 0, 0, -1, 0, // Index: 308
        4, 2.4, -1, 1, 0, 0, 0, -1, 0, // Index: 309
        4, 2.4, -0.5, 1, 0, 0, 0, -1, 0, // Index: 310
        //down-bottom        //green
        2, 4, -0.5, 0, 1, 0, 0, -1, 0, // Index: 311
        2, 4, -1, 0, 1, 0, 0, -1, 0, // Index: 312
        4, 3, -1, 0, 1, 0, 0, -1, 0, // Index: 313
        4, 3, -0.5, 0, 1, 0, 0, -1, 0, // Index: 314
        //downright  //white
        2, 3.4, -1, 1, 1, 1, 1, 0, 0, // Index: 315
        2, 4, -1, 1, 1, 1, 1, 0, 0, // Index: 316
        2, 4, -0.5, 1, 1, 1, 1, 0, 0, // Index:317
        2, 3.4, -0.5, 1, 1, 1, 1, 0, 0, // Index: 318
